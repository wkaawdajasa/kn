...
@router.get("/products")
async def list_products(request: Request, orderable_only: bool = False) -> List[Dict[str, Any]]:
    ...
    products = await db.products.find(pexcl.visibility_query(actor), {"_id": 0}).to_list(500)
