...
async def seed_hr_payroll_foundation() -> None:
    """FASE H4 — seed contoh payroll run periode bulan lalu (idempotent) agar UI berisi data.
    Status di-set 'approved' (slip muncul di ESS + tombol Post GL/Pay tersedia untuk demo)."""
    ...
    try:
        ...
        print(f"[seed_hr_payroll] skip: {e}")
