        ...
        <div className="grid gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="grid gap-1">
              ...
              <select data-testid="asset-category-select" className="field" value={form.category}
            ...
            <label className="grid gap-1">
              ...
              <select data-testid="asset-account-select" className="field" value={form.gl_account_asset}
                onChange={(e) => set("gl_account_asset", e.target.value)}>
                {accounts.length === 0 && <option value="">(default kategori)</option>}
          ...
          {entities.length > 1 && (
            <label className="grid gap-1">
              ...
              <select data-testid="asset-entity-select" className="field" value={form.entity_id}
                onChange={(e) => set("entity_id", e.target.value)}>
                {entities.map((en) => (
                  <option key={en.id} value={en.id}>{en.short_name || en.legal_name}</option>
                ))}
              </select>
            </label>
          )}
