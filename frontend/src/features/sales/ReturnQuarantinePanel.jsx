              ...
              {rolls.map((r) => {
                ...
                return (
                  <tr key={r.id} data-testid={`quarantine-roll-${r.id}`}>
                    <td className="font-mono text-[10.5px]">{r.roll_number}</td>
        ...
        <div className="modal-overlay" data-testid="transfer-ownership-modal">
          <div className="modal-card small">
            ...
            <p className="modal-subtitle">
              Roll <b>{xferRoll.roll_number}</b> ({fmtNum(xferRoll.length_remaining ?? xferRoll.length)} m) —
      ...
      {unscrapRoll && (
        <div className="modal-overlay" data-testid="unscrap-modal"
          ...
          <div className="modal-card small">
            ...
            <p className="modal-subtitle">
              Roll <b>{unscrapRoll.roll_number}</b> ({fmtNum(unscrapRoll.length_remaining ?? unscrapRoll.length)} m) akan
