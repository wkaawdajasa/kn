...
export default function PurchaseOrderManagement({ user, selectedEntity, onApprovePO, focusDoc, onClearFocus, onOpenDocument }) {
  ...
  const paged = usePagedList("/purchase-orders", { pageSize: 20, search });
  ...
  const [newItem, setNewItem] = useState({ product_id: "", quantity: 0, unit: "meter", price: 0, discount_percent: 0, expected_grade: "" });
