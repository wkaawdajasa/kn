              ...
              <div className="space-y-2">
                ...
                {outcome === "refund" && (
                  <div className="rounded-md border border-[#E7E1F5] bg-[#F8F5FE] p-2" data-testid="rma-refund-account-box">
                    ...
                    <select data-testid="rma-refund-account" className="field w-full !py-1 text-[12px]" value={refundAccount} onChange={(e) => setRefundAccount(e.target.value)}>
              ...
              <div className="space-y-2" data-testid="goods-back-block">
                ...
                {allRolls.map((r) => (
                  <div key={r.roll_id} className="flex items-center justify-between gap-2 text-[11px]">
                    ...
                    <select data-testid={`goods-back-grade-${r.roll_id}`} className="field !py-1" style={{ minWidth: 64 }}
                      value={regradeMap[r.roll_id] || "B"} onChange={(e) => setRegradeMap((m) => ({ ...m, [r.roll_id]: e.target.value }))}>
