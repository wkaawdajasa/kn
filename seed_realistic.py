...
async def seed_users():
    ...
    print("✅ Users seeded (with entity assignment) — 10 akun · 6 peran "
          "(admin · manager×2 · sales_admin · finance · sales×3 · warehouse×2)")
...
async def seed_products():
    ...
    print("✅ Products seeded (11 products incl. variants) + reorder points + 1 produk eksklusif (PS-20)")
...
async def seed_makloon_orders():
    ...
    def _step(qty_out):
        return {"process_type": "tenun", "makloon_id": "mak_seed_tenun", "recipe_id": "prcp_seed_tenun",
                ...
                "yield_factor": 3.8, "waste_pct": 4, "byproduct_pct": 2, "tariff": 3500}
